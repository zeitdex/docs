...
`,
                ...
                ( specialist.procedure_type == 'researched' )
                    ? `
::: tip
This is a summary of the procedure on their site.  [Let us know](https://github.com/zeitdex/resources/issues/new?template=procedure-feedback.md&title=Feedback+about+the+procedure+for+${encodeURIComponent(specialist.name.value)}) how things work in reality!
:::
` : '',
...
[Provide&nbsp;feedback&nbsp;about&nbsp;this&nbsp;specialist](https://github.com/zeitdex/resources/issues/new?template=entity-feedback.md&title=Feedback+for+${encodeURIComponent(specialist.name.value)}) <EntryUpdated date="${specialist.last_updated}"/>
...
[Provide&nbsp;feedback&nbsp;about&nbsp;this&nbsp;software](https://github.com/zeitdex/resources/issues/new?template=entity-feedback.md&title=Feedback+for+${encodeURIComponent(source.name.value)}) <EntryUpdated date="${source.last_updated}"/>
...
if ( fs.existsSync(`${base_dir}/../resources/Makefile`) ) {
    ...
    https.get(
        'https://raw.githubusercontent.com/zeitdex/resources/built/entities.json',
        res => {
            let json = '';
